...
class ClockView: UIView
{
    ...
    func timerFired(sender: AnyObject)
    {
        ...
        if(hours < 18 && hours > 5)
        {
            clockBgColor = UIColor(red: 0.6314, green: 0.8863, blue: 0.9882, alpha: 1.0) /* #a1e2fc */
            digitColor  = UIColor.blackColor()
        }
        else
        {
            clockBgColor = UIColor(red: 0, green: 0.0824, blue: 0.6275, alpha: 1.0) /* #0015a0 */
